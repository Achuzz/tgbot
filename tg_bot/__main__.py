...
PM_START_TEXT = """
Hi {}, my name is {}! . I'm So Glad that you decided to use me.. 😉 If you have doubts for using me  just use /help command.... if you still doubts after using that command you can ask freely at @mariebotmalayalamsupport ❤️
